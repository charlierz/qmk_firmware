...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
        ...
        KC_LGUI, KC_A, KC_S, KC_D, KC_F, KC_G,          KC_H, KC_J, KC_K, KC_L, KC_COLN, KC_MINS,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_ENT,  TO(3), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
        OSM(MOD_MEH), LT(2,KC_TAB), LCTL_T(KC_ESC), KC_SPC,  KC_ENT, LT(1,KC_BSPC), LALT_T(KC_DEL), KC_NO
    ),
	[1] = LAYOUT(
